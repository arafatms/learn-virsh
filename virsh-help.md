...
分组的命令：
 ...
 Domain Management (help keyword 'domain'):
    ...
    blockbackup                    Start a block backup operation.
    ...
    qemu-live-upgrade              Live upgrade QEMU binary version of a running domain
    reboot                         重新启动一个域
    reset                          重新设定域
    ...
    vncdisplay                     vnc 显示
    blkdevshareable                change shareable status of disk
    domifqueues                    get/set number of interface queues
